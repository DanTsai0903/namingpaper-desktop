# Capability: paper-detail

## Purpose

Displays detailed paper information including metadata header, AI summary, inline PDF preview, action toolbar, and inline category editing.
