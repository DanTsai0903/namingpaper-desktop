# Capability: pdf-editor-ui

## Purpose

Provides the dedicated editor window UI for annotating PDFs, including toolbar, property panel, keyboard shortcuts, save controls, and cursor feedback.
