# Capability: sqlite-reader

## Purpose

Provides read-only SQLite database access for the macOS app, handling paper model mapping, pagination, FTS5 search, filtered queries, async loading, reactive updates, and schema version checking.
